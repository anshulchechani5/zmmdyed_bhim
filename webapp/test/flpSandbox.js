					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dyed Bhem Dispatch For Subcontracting",
									"targetURL": "#zmmdyedbhim-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmmdyedbhim-display": {
								"semanticObject": "zmmdyedbhim",
								"action": "display",
								"description": "Dyed Bhem Dispatch For Subcontracting",
								"title": "Dyed Bhem Dispatch For Subcontracting",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmdyedbhim",
									"url": sap.ui.require.toUrl("zmmdyedbhim")
								}
							}
						}
					}
